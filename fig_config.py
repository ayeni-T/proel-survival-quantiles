...
COLORS = {
    ...
    'plel'     : '#009E73',
    'bootstrap': '#D55E00',
    'bartlett' : '#CC79A7',   # v4 addition -- Bartlett-corrected PROEL
    'nominal'  : '#999999',
    'band'     : '#0072B2',
    'group1'   : '#0072B2',
    'group2'   : '#D55E00',
...
LINESTYLE = {
    ...
    'plel'     : '-.',
    'bootstrap': ':',
    'bartlett' : (0, (5, 1, 1, 1)),   # v4 addition -- distinct dash pattern
    'nominal'  : (0, (3, 1, 1, 1)),
    'sim_band' : '--',
    'zero'     : '-',
}
...
METHOD_LABELS = {
    ...
    'bartlett' : 'PROEL (Bartlett-corrected)',   # v4 addition
}
